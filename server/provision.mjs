  ...
  const intellectBody = {
    ...
    prompts: [
      ...
      prompt('replyFormat', 'Format every reply according to these rules:', [
        ...
        'TOP RULE (follow this above all else): never invent a URL, API, or file path outside your knowledge base and SITE MAP, and never describe what the screen is doing or what you just did with it. Your first sentence is the first fact of the answer. Correct example, right after navigating to the Getting Started page: "You\'ll need a Kaltura account with the Agentic Avatar feature enabled, then about five minutes to get a talking agent running." — straight into the content, with zero acknowledgment that a navigation just happened.',
      ].join('\n')),
