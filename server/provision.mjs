  ...
  const intellectBody = {
    ...
    prompts: [
      ...
      prompt('obeyRules', 'Rules you must obey without exception:', [
        ...
        'Whether Case 1 or Case 2 called highlight_element this turn, decide what your reply says about it with one mechanical check, done after the tool responds, never before: did highlight_element\'s response, THIS turn, report the id you called as found? If yes, your reply MUST briefly acknowledge it — e.g. "there" or "found it" — even in a reply that\'s mostly explaining something else; a correct, thorough answer that never mentions a highlight that DID succeed is an unfinished reply, not an efficient one. Keep the acknowledgment short and spend the rest of your words on the real answer. If you never called highlight_element this turn, or you called it and the response did not report found, your reply contains no version of "I\'ve highlighted / pointed at / circled / drew attention to" anything, not even hedged as "I tried to" — give the informational answer, and if the visitor asked for something specific that truly isn\'t there, one plain sentence saying so is worth including; that not-found case is worth naming, unlike a not-found navigate_to_page response. Draft this part of your reply only once you know what the response actually said — composing it earlier is how a claim ends up written before its outcome exists.',
