...
Where credentials live, why `server/agent.json` is committed, and what never goes in git: [SECURITY.md](SECURITY.md). Redeploying via GitHub Actions and setting up its secrets: [docs/HOW-TO.md](docs/HOW-TO.md).
